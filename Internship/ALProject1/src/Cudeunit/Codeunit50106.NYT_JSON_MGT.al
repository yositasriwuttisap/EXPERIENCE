/**codeunit 50106 "NYT JSON Mgt"
{
    ...
    begin
        ...
        foreach JToken in JArray do begin
            ...
            NYTBestSellersTheme."HolidayWeekDay" := CopyStr(GetValueAsText(JToken, 'HolidayWeekDay'), 1, MaxStrLen(NYTBestSellersTheme."HolidayWeekDayThai"));
            NYTBestSellersTheme."HolidayWeekDayThai" := CopyStr(GetValueAsText(JToken, 'HolidayWeekDayThai'), 1, MaxStrLen(NYTBestSellersTheme."HolidayWeekDayThai"));
            NYTBestSellersTheme.HolidayDescription := CopyStr(GetValueAsText(JToken, 'HolidayDescription'), 1, MaxStrLen(NYTBestSellersTheme.HolidayDescription));
            NYTBestSellersTheme."Date" := DT2Date(EvaluateUTCDateTime(GetValueAsText(JToken, 'Date')));
            NYTBestSellersTheme."DateThai" := DT2Date(EvaluateUTCDateTime(GetValueAsText(JToken, 'DateThai')));
